//! # Gemini API Data Models for Batch Operations
//!
//! This module provides the data structures for performing asynchronous,
//! large-scale batch processing with the Gemini API. It includes models for
//! creating, managing, and retrieving the results of batch jobs.

use serde::{Deserialize, Serialize};
use snafu::Snafu;
use time::OffsetDateTime;

use crate::common::serde::{i64_as_string, key_as_string};
