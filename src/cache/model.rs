//! # Gemini API Data Models for Content Caching
//!
//! This module contains data structures for managing cached content with the Gemini API.
//! Caching content can speed up responses and reduce token usage for frequently used
//! prompts or data.
...
use crate::tools::model::{Tool, ToolConfig};
