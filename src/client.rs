...
pub enum Error {
    ...
    #[snafu(display("file search store operation failed precondition: {message}"))]
    FileSearchStorePrecondition {
        message: String,
    },

    #[snafu(display("file search operation failed due to resource constraints: {message}"))]
    FileSearchResourceExhausted {
        message: String,
    },

    #[snafu(display("file search document processing failed: {message}"))]
    FileSearchDocumentFailed {
        message: String,
    },
}
