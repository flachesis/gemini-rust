//! # Gemini API Data Models for Content Generation
//!
//! This module contains the data structures used for generating content with the Gemini API.
//! It includes request and response structs, configuration options, and various enums
//! that control the generation process.

use serde::{Deserialize, Serialize};

use crate::models::{CitationMetadata, Content, Part};
use crate::safety::model::{PromptFeedback, SafetyRating, SafetySetting};
use crate::tools::model::{FunctionCall, Tool, ToolConfig};
