//! # Gemini API Data Models for File Management
//!
//! This module contains the data structures for managing files with the Gemini API,
//! including the `File` resource itself, its various states, and responses for
