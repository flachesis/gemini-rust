...
pub struct File {
    ...
    pub name: String,
    /// The URI of the file for use in API requests.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub uri: Option<Url>,
    /// The download URI of the file.
    ///
    /// **Only present for files generated by the Gemini API** (e.g., generated images, audio).
    /// Uploaded files do not have a download URI and cannot be downloaded.
    #[serde(skip_serializing_if = "Option::is_none")]
